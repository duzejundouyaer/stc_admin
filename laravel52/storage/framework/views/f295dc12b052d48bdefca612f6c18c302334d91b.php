...
<head>
    ...
    <script src="<?php echo e(asset('style/admin/js/jrj6out.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('style/admin/js/prefixfree.min.js')); ?>"></script>
...
<script src='<?php echo e(asset('style/admin/js/jquery.min.js')); ?>'></script>
<script src='<?php echo e(asset('style/admin/js/TweenMax.min.js')); ?>'></script>
<script src='<?php echo e(asset('style/admin/js/three.min.js')); ?>'></script>
<script src="<?php echo e(asset('style/admin/js/index.js')); ?>"></script>
