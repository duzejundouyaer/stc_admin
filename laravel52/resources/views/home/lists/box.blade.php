    ...
    {{--<form name="aspnetForm" method="post" action="movie_list.aspx?ClientID=" id="aspnetForm">--}}
        ...
        <div class="head">
            <ul>
                ...
                <li class="fr city Hide">
                    <label>
                        <p class="fl paint Hide"><a href="" style="color: white;"><b id="defaultCityName"></b></a></p>
        ...
        <div class="nav">
            <div class="tab_nav tab_nav_one">
                <a class="hide" href="javascript:void(0);history.back(-1);"><img src="http://m.douyou100.com/Resources/douyou100_1/images/return.png" width="20" height="16" class="fl"/></a><div class=" Hide fl">票房排行<span></span></div>
            </div>
        </div>
